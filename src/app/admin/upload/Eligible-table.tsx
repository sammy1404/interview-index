...
const Eligibility: React.FC<EligibilityProps> = ({ company }) => {
  ...
  const next=()=>{
    router.push(`/admin/upload/rounds/${company}`); // Redirect after successful insertion
  }
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-5 mb-10">
      ...
      <div>
        ...
        <button className="hover:bg-muted-foreground hover:text-primary-foreground text-ring px-5 py-2 rounded-md transition-all duration-300" onClick={next}>Go to the next page</button>
      </div>
    </div>
  );
};
